...
// ILI9341_t3 tft = ILI9341_t3(TFT_CS, TFT_DC, TFT_MOSI, TFT_CLK, TFT_RST, TFT_MISO);  // Create a display object and inform the library of the pinout for working with graphics
